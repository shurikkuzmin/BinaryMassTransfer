...
def show_fields(dir_name,file_name):
    ...
    uy=numpy.loadtxt(dir_name+"velx0080000.dat").transpose()
    #ux_orig=numpy.loadtxt(dir_name+"")
    #uy_orig=numpy.loadtxt(dir_name+"")
    dims=density.shape    
    pylab.figure(1)    
...
def prepare_bunch_files(dir_name):
...
if __name__=="__main__":
    ...
    #prepare_bunch_files_sailfish(file_dir)   
    pylab.show()