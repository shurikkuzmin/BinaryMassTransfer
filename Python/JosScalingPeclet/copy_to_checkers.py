...
def run_simulations():
    ...
    subprocess.call(['scp',"open_boundaries.cpp",'shurik@checkers.westgrid.ca:/home/shurik/JosScalingPeclet/']) #+scale_str[scale_counter]+"/density"+'0'*(7-len(name))+name+".dat","."])
    subprocess.call(['scp',"govern.py",'shurik@checkers.westgrid.ca:/home/shurik/JosScalingPeclet/'])
    subprocess.call(['scp',"binary.pbs",'shurik@checkers.westgrid.ca:/home/shurik/JosScalingPeclet/'])
    ...
    for counter,dir_temp in enumerate(capillary_str):
        ...
        subprocess.call(['scp',"geometry.dat",'shurik@checkers.westgrid.ca:/home/shurik/JosScalingPeclet/'+dir_temp+"/"]) #+scale_str[scale_counter]+"/density"+'0'*(7-len(name))+name+".dat","."])
        subprocess.call(['scp',"velx0200000.dat",'shurik@checkers.westgrid.ca:/home/shurik/JosScalingPeclet/'+dir_temp+"/"])
        subprocess.call(['scp',"vely0200000.dat",'shurik@checkers.westgrid.ca:/home/shurik/JosScalingPeclet/'+dir_temp+"/"])
        os.chdir("..")
