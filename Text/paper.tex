...
properly design a microchannel properties as the channel length, channel length to ensure best possible chemical reactions . In
...
numbers as $Ca<0.6$ for square microchannels there is a vortex in the reference frame moving with the bubble, which certainly influences and improves the corresponding mass transfer. 
Note that the flow
...
\end{aligned}
\end{equation}
We as well need to address the concentration being in a whole system non-dimensionalized towards the equilibrium:
...
a steady-state condition the average of concentration values between $500000$ to $1000000$ time steps. The values are presented 
\begin{figure}
...
state can be reached after $500000$. The mass transfer coefficient is taken as the average of concentration values between $500000$ to $1000000$ time steps..\label{fig:steady:state}}
\end{figure}
