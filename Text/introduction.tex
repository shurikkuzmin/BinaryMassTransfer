...
that the difference between inlet/outlet and the space-averaged over the whole unit cell concentration is not significant. Thus, the tracer is well mixed in the slug.
\item
