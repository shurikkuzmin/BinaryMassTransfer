...
reactors and trickle bed reactors \cite{kreutzer-overview,bercic-mass}. Monolith reactors usually operate in Bretherton-Taylor regime \cite{bretherton,taylor} which describes a flow through
...
transfer from gas and walls to liquid; the plug flow nature that separates liquid slugs from each
