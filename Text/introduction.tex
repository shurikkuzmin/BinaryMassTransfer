...
a thorough procedure of how to measure the volumetric mass transfer coefficient depending on the
capillary number $Ca$ regime. For example, for $Ca<0.7$ the flow has a vortex in front of the
bubble, but for the larger capillary number it hasn't. In case of mass
sources to be comparable of the representative unit cell (inhomogenous
situation), one cannot estimate  the strategies to measure the volumetric mass transfer coefficient
are presented. The strategies of how to speed up simulations, what the boundaries conditions are
