...
bubble, but for the larger capillary number it hasn't;  the mass sources is comparable of the
...
a liquid medium of equal sized, long in comparison with the height bubbles in microchannels, see
...
in macroscopic counterparts: such as thin films \cite{bretherton} which can remarkably enhance mass
transfer in the film from gas or wall; the plug flow nature that separates liquid slugs from each
...
of Bretherton-Taylor bubble train flow: continous flow analyzers, lung openings, chemical reactions
...
reactions are performed in the best manner \cite{bercic}. A number 
  This
