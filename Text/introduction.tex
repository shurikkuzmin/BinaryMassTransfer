...
that the concentration difference between the inlet/outlet- and the space-averaged over the whole unit cell is not significant. Thus, the tracer is well mixed in the slug.
\item
...
The same correlations were examined for a different velocity pattern $Ca=1.040$. %, initial
...
x^2\Bigr)$ and through orthogonality (Stourm-Liouiville theorem) obtain coefficients:
\beq
